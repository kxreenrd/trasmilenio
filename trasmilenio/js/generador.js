...
class generador {
    ...
    prueba_promedio() {
        var resul = 0, promedio = 0, raiz =0, denom =0,numerador= 0;
        ...
        promedio = sum / n;
        raiz = Math.sqrt(n);
        denom = Math.sqrt((1 / 12));

        numerador = (promedio - (1 / 2)) * raiz;
    ...
    prueba_frecuencia() {
        ...
        var fe = n / 5;
        var sumatoria = g.suma(pq1, fe) + g.suma(pq2, fe) + g.suma(pq3, fe) + g.suma(pq4, fe) + g.suma(pq5, fe);
        /*var resta = pq1 - fe;
        ...
        console.log('fe:', fe, 'sumatoria: ', sumatoria, 'x2: ', Math.pow(sumatoria, 2));
        document.getElementById('frecuencia').innerHTML = 'x: '+ sumatoria;
        document.getElementById('frecuencia1').innerHTML = 'x²: '+ Math.pow(sumatoria, 2);
    ...
    definir() {
        document.getElementById('resultados_p').style.display = 'block';
        ...
        if (!a || !m || !x1) {
            ...
            console.log('1-> a ', a, 'c ', c, 'm ', m, 'semilla ', x1, 'opcion ', opcion);
            //g.arr();
            g.generar(opcion);
        }
    ...
    arr() {
        console.log('entro a arr', arr_mixto);
        return arr_mixto;
    }
}
