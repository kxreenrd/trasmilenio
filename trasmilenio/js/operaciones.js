...
var buses_derecha_l = 0;
var buses_izquierda_l = 0;
    ...
    if (ingreso < 0) {
        ...
        if (cant > 0) {
            ...
            var it = window.setInterval(function () {
                ...
                //console.log(,u)
                //node.innerHTML = u;
                node.className = tipo_persona(g.pedir_dato()) + ' animated bounceInLeft';
...
function llegada(minutos){
    bus_a = enteros(g.pedir_dato());
    bus_b = enteros(g.pedir_dato());
    bus_c = enteros(g.pedir_dato());
    bus_d = enteros(g.pedir_dato());
    ...
    buses_derecha_l = bus_a+bus_b;
    buses_izquierda_l = bus_c+bus_d;
...
function respuestas() {
    ...
    document.getElementById('q_4').innerHTML = buses_derecha_l + buses_izquierda_l;
    document.getElementById('q_5').innerHTML = buses_derecha_l;
    document.getElementById('q_6').innerHTML = buses_izquierda_l;
    
    
    
    //setTimeout(function () {document.getElementById('busa').innerHTML = '';}, 50);
}
